    ...
    axios
      ...
      .then(({ data }) => {
        ...
        setState({
          ...
          caseFatality: (data[0].deaths / data[0].cases*100).toLocaleString(),
        ...
        <div>
          ...
          {toggle && (
            <div className='m-2.5 p-2.5 flex justify-center items-center bg-gray-300 bg-opacity-30'>
              ...
              <span className='m-2.5 p-2.5 flex justify-center items-center text-gray-900 font-bold uppercase px-6 py-2 text-l outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'>New Deaths: {state.todayDeaths}</span>
              <span className='m-2.5 p-2.5 flex justify-center items-center text-gray-900 font-bold uppercase px-6 py-2 text-l outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'>New Recovered: {state.todayRecovered}</span>
